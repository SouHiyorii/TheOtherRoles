...
namespace TheOtherRoles {
    ...
    public static class Helpers
    {
        ...
        public static bool hidePlayerName(PlayerControl source, PlayerControl target) {
            ...
            else if (TORMapOptions.impostorsKnowTeammates && source.Data.Role.IsImpostor && (target.Data.Role.IsImpostor || target == Spy.spy || target == Sidekick.sidekick && Sidekick.wasTeamRed || target == Jackal.jackal && Jackal.wasTeamRed)) return false; // Members of team Impostors see the names of Impostors/Spies
